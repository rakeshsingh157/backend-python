...
@profile_bp.route('/api/<user_id>/profile', methods=['GET'])
...
@profile_bp.route('/api/<user_id>/profile', methods=['POST'])
...
@profile_bp.route('/api/<user_id>/profile/photo', methods=['POST'])
...
@profile_bp.route('/api/<user_id>/profile/contact', methods=['POST'])
...
@profile_bp.route('/api/<user_id>/profile/change-password', methods=['POST'])
...
@profile_bp.route('/api/<user_id>/events', methods=['GET'])
